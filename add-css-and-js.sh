...
append_js $sc_web_path/templates/components.html components/js/set_calculator/set_calculator.js
append_css $sc_web_path/templates/components.html components/css/set_calculator.css
